...
/**
 * @fileOverview A tech article summarization AI agent.
 *
...
const SummarizeArticleInputSchema = z.object({
  articleText: z.string().describe('The text content of the tech article to summarize.'),
});
export type SummarizeArticleInput = z.infer<typeof SummarizeArticleInputSchema>;

const SummarizeArticleOutputSchema = z.object({
  summary: z.string().describe('A concise summary of the tech article.'),
});
...
const summarizeArticlePrompt = ai.definePrompt({
  ...
  prompt: `You are an expert in summarizing tech articles. Please provide a concise summary of the following article:\n\n{{{articleText}}}`,
});
