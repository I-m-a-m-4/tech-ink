...
export const ArticleSchema = z.object({
  ...
  content: z.string().describe("The full content of the article, formatted in Markdown. Should be several paragraphs long, with headings and lists where appropriate."),
  imageUrl: z.string().describe("A URL for the article's image from Unsplash."),
  ...
  externalUrl: z.string().optional().describe("A URL for the link to the full article. Should be a placeholder link."),
