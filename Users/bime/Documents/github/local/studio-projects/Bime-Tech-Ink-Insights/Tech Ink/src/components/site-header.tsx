...
const navLinks = [
    ...
    { href: "/timelines", label: "Timelines", icon: <Icons.timeline className="h-5 w-5" /> },
    ...
    const dropdownContent = (
      <>
        ...
        <DropdownMenuItem asChild>
            <Link href="/briefing" onClick={() => pathname !== '/briefing' && startLoader()}>
                <Icons.briefing className="mr-2 h-4 w-4" />
